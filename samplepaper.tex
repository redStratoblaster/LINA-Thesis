...
\bibitem{ref_article5} 	\textbf{Tateno, M., Skokauskas, N., Kato, T. A., Teo, A. R., & Guerrero, A.} (2016). New game software (Pokémon Go) may help youth with severe social withdrawal, hikikomori. Psychiatry research, 246, 848-849. \doi{10.1016/j.psychres.2016.10.038}

\bibitem{ref_article6} \textbf{Kato, T. A., Teo, A. R., Tateno, M. , Watabe, M. , Kubo, H. and Kanba, S.} (2017), Can Pokémon GO rescue shut‐ins (hikikomori) from their isolated world?. Psychiatry Clin. Neurosci., 71: 75-76. \doi{10.1111/pcn.12481}

\bibitem{ref_article7} \textbf{Pettigrew, T. F.} (1998). INTERGROUP CONTACT THEORY. Annual Review of Psychology, 49(1), 65–85. \doi{10.1146/annurev.psych.49.1.65}
